        ...
        public static void Main(string[] args)
        {
            ...
            app.MapGet("/", async context =>
            {
                ...
                if (context.User.Identity?.IsAuthenticated ?? false)
                    await context.Response.SendFileAsync("HtmlPages/MainPageForAuthorized.html");
                else
                    await context.Response.SendFileAsync("HtmlPages/MainPageForUnauthorized.html");
            });
            ...
            app.MapGet("/registration", async context =>
            {
                ...
                {
                    context.Response.ContentType = "text/html";
                    await context.Response.SendFileAsync("HtmlPages/Registration.html");
                }
            });
            ...
            app.MapGet("/signing", async context =>
            {
                ...
                {
                    context.Response.ContentType = "text/html";
                    await context.Response.SendFileAsync("HtmlPages/EnteringAccount.html");
                }
            });
            ...
            app.MapGet("/{username}", async (string username, HttpContext context) =>
            {
                ...
                if ((int)result == 1)
                {
                    ...
                    if (user == username)
                        await context.Response.SendFileAsync("HtmlPages/ProfileForOwner.html");
                    else
                        await context.Response.SendFileAsync("HtmlPages/ProfileForNotOwner.html");
                }
            ...
            app.MapGet("/{username}/createportfolio", async (string username, HttpContext context) =>
            {
                ...
                {
                    context.Response.ContentType = "text/html";
                    await context.Response.SendFileAsync("HtmlPages/CreatingPortfolio.html");
                }
                ...
                if ((int)result == 1)
                {
                    ...
                    if (context.User.Identity?.IsAuthenticated ?? false)
                    {
                        if (context.User.FindFirstValue(ClaimTypes.NameIdentifier) == username)
                            await context.Response.SendFileAsync("HtmlPages/PortfolioForOwner.html");
                        else
                            await context.Response.SendFileAsync("HtmlPages/PortfolioForAuthorized.html");
                    }

                    else
                        await context.Response.SendFileAsync("HtmlPages/PortfolioForUnauthorized.html");
                }
            ...
            {
                context.Response.ContentType = "text/html";
                await context.Response.SendFileAsync("HtmlPages/SearchPage.html");
            });
